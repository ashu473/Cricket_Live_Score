package com.example.LiveScore.services.impl;

import com.example.LiveScore.entities.Match;
import com.example.LiveScore.repository.MatchRepo;
import com.example.LiveScore.services.MatchService;
    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                matches.add(match1);
                updateMatchInDb(match1); // update the match in the database
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
